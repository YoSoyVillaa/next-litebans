  ...
  return (
    <div className="mr-4 hidden md:flex">
      ...
      <nav className="flex items-center gap-6 text-sm">
        ...
        >
          {dictionary.words.bans.plural} <Badge variant={pathname.startsWith("/bans") ? "default" : "secondary"} className="!px-1 !py-0">{bans}</Badge>
        </Link>
        ...
        >
          {dictionary.words.mutes.plural} <Badge variant={pathname.startsWith("/mutes") ? "default" : "secondary"} className="!px-1 !py-0">{mutes}</Badge>
        </Link>
        ...
        >
          {dictionary.words.warns.plural} <Badge variant={pathname.startsWith("/warns") ? "default" : "secondary"} className="!px-1 !py-0">{warns}</Badge>
        </Link>
        ...
        >
          {dictionary.words.kicks.plural} <Badge variant={pathname.startsWith("/kicks") ? "default" : "secondary"} className="!px-1 !py-0">{kicks}</Badge>
        </Link>
      </nav>
    </div>
  )
